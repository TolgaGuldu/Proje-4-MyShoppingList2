...
public class Urun_Ekle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ekle.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Urun_Ekle.this, result.toString(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    AsyncTask<Object, Object, Object> urunEkleGorev = new AsyncTask<Object, Object, Object>() {
        ...
        protected Object doInBackground(Object... params) {
            ...
            veriTabani.Urun_Ekle(urun_adi.getText().toString(), Favori_tick.isChecked(),
        ...
        Favori_tick.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((CheckBox) v).isChecked()) {
                    Toast.makeText(Urun_Ekle.this, "Bro, try Android :)", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
